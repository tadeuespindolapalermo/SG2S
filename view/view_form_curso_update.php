<?php
    ...
    <div class="container">
        <div class="col-md-4">
            <div style="text-align: center;"><h4><strong>Atualizar Curso</strong></h4></div>
            <div style="text-align: center;"><h5><strong><font color="#FF0000">'.strtoupper($curso->getNome()).'</font><strong></h5></div>
