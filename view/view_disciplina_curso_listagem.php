            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="table-responsive">
                        <h3 class="text-muted" style="text-align: center;">Cursos da disciplina <?php echo $disciplina->getNomeDisciplina(); ?></h3><hr />
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Cursos da disciplina <?php echo $disciplina->getNomeDisciplina(); ?> </h5>
