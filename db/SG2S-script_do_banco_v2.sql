...
CREATE TABLE IF NOT EXISTS `codigofonteonline1`.`grade_horaria` (
  ...
  `dsSegSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de SEGUNDA-FEIRA.',
  `dsTerSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de TERÇA-FEIRA.',
  `dsQuaSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de QUARTA-FEIRA.',
  `dsQuiSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de QUINTA-FEIRA.',
  `dsSexSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de SEXTA-FEIRA.',
  `dsSabSala` VARCHAR(200) CHARACTER SET 'utf8' COLLATE 'utf8_general_ci' NULL COMMENT 'Sala da disciplina de SÁBADO',
